...
public class Main {
    ...
    private static Map<Integer, CargoCarriageType> cargoTrain = new HashMap<>();
    private static Map<Integer, PassengerCarriageType> passengerTrain = new HashMap<>();
    ...
    public static void main(String[] args) {
        try (BufferedReader br = new BufferedReader(new InputStreamReader(System.in))) {
            ...
            trainType = br.readLine().toUpperCase();
            int limitOfCars;
            switch (trainType) {
                case "PASSENGER":
        ...
        if (!cargoTrain.isEmpty()) {
            ...
            for (Map.Entry<Integer, CargoCarriageType> map : cargoTrain.entrySet()) {
        ...
        if (!passengerTrain.isEmpty()) {
            ...
            for (Map.Entry<Integer, PassengerCarriageType> map : passengerTrain.entrySet()) {
                System.out.println("Car number " + map.getKey() + ": " + map.getValue());
            }
        }
    }
